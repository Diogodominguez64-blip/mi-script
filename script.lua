...
-- Version: 3.2 (Aimbot, Name ESP, Silent Aim, Wall Check, FOV & Smoothness Slider, Teleportation)
-- ==========================================
...
    raycastParams.FilterType = Enum.RaycastFilterType.Ex
local raycastParams = RaycastParams.new()
raycastParams.FilterDescendantsInstances = {character}
raycastParams.FilterType = Enum.RaycastFilterType.Exclude
...
                    print("Teleported to " .. closestPlayer.Name .. " at a distance of " .. lowestDistance .. " meters.")
                end
            else
